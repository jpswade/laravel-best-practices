...
Architectural and naming defaults that Laravel Boost does not cover. Boost's `architecture.md`, `controllers.md`, `jobs.md`, and `queues.md` describe *what to do* with each class; this file is about *how to size and name them*.
...
- [`controllers.md`](https://github.com/laravel/boost/blob/main/.ai/laravel/skill/laravel-best-practices/rules/controllers.md) — thin-controller doctrine; the "no logic in routes" section above is the same rule applied one layer earlier.
- [`jobs.md`](https://github.com/laravel/boost/blob/main/.ai/laravel/skill/laravel-best-practices/rules/jobs.md) and [`queues.md`](https://github.com/laravel/boost/blob/main/.ai/laravel/skill/laravel-best-practices/rules/queues.md) — Boost owns "what a job looks like" and how to dispatch; the named-queues section above adds the operational dimension.
