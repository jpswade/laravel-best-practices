...
Opinionated PHP control-flow guidance for cases where Laravel Boost is silent. Boost's `error-handling.md` covers how to *report* exceptions; this file covers how to *avoid* using exceptions for control flow in the first place.
